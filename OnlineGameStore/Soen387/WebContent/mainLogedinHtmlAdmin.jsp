	 ...
	 <form action="Controller" method="get" class="login" >
		 ...
		 <center >
			 ...
			 <tr><th>MAIN PAGE </th></tr>
				...
				<tr>	<td> <input type="submit" value="Game Options" name="toDiscountAdmin" /> </td></tr>
				<tr>	<td> <input type="submit" value="Search"  name="toSearch"/> </td></tr>
				<tr>	<td> <input type="submit" value="User Statistics"  name="toUserStat"/> </td></tr>
				<tr>	<td> <input type="submit" value="Game Inventory"  name="toGameInventory"/> </td></tr>
				<tr>	<td> <input type="submit" value="User Management"  name="toUserManagement"/> </td></tr>	 
			 </table>
		 </center>
