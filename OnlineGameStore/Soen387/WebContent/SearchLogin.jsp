	   ...
	   //get users imput from the search form
		...
		while(rs.next())
		   ...
		   {			
				...
				out.println("<form action='Controller' method=\"get\" id='myGameform' > <div id=\"divv\"> <table     \"> <tr> <td> "+rs.getString(2)+" </td> </tr>	<tr> <td ><img src="+rs.getString(11)+"></td> </tr> <tr> <td> Gender:  "+rs.getString(7)+" </td> </tr> <tr> <td>Price:  "+rs.getInt(15)+"$</td> <tr> <td>Date:  "+rs.getDate(8)+"</td> <tr> <td> <input type=\"hidden\" name=\'a"+gameidvalue+"\' value=\'"+gameidvalue+"\' /> <input type=\"submit\" value=\"Display Details\" name='searchDetails' /> </td></tr>    <tr> <td> <input type=\"hidden\" name=\'id"+gameidvalue+"\' value=\'"+gameidvalue+"\' /> <input type=\"submit\" value=\"Add to Favorite\" name='addToFavorite' /> </td></tr>   <tr> <td> <input type=\"hidden\" name=\'cart"+gameidvalue+"\' value=\'"+gameidvalue+"\' /> <input type=\"submit\" value=\"Add to Cart\" name='addToCart' /> </td></tr>  </table> </div>  </form>");			  		
		   }
		   con.close();
