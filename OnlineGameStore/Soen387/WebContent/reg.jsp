         ...
         Statement st=con.createStatement();
          ...
          ps= con.prepareStatement("INSERT INTO usertable (firstname,lastname,email,address1,address2,city,zip,country,credit_card_type,credit_card_number,credit_card_cvv,credit_card_expiry,state,password)  VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		   ...
		   if(s14.equalsIgnoreCase(s15))
		   {
		           ...
		           if (insertResult!=0)
		          {
		               out.println("<a href=\"mainHtml.jsp\">Registration was successful. <br/> Continue to Main Page</a>");	
		          }
		   }
           			...
           			out.println("<a href=\"mainHtml.jsp\">Registration was not succesfull , <br/> Continue to Main Page and try again</a>");
           		}
