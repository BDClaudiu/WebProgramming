...
try {
	...
	while(rs.next())
	{
		String s300=request.getParameter("abc"+rs.getString(2));
	
		if(s300!=null)
		{	
		 	ResultSet rs32= null;
		 	Statement st32=con.createStatement();
		 	PreparedStatement ps32= con.prepareStatement("UPDATE carttable SET quantity='"+s300+"' WHERE email='"+email+"' AND gamename='"+rs.getString(2)+"'");
		 	ps32.executeUpdate();
