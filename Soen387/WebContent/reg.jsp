      ...
      Class.forName("com.mysql.jdbc.Driver");
	   ...
	   Connection con=DriverManager.getConnection(databaseUrl, databaseUser,databasePass);
         ...
         Statement st=con.createStatement();
          ...
          ps= con.prepareStatement("INSERT INTO gametable (firstname,lastname,email,address1,address2,city,zip,country,credit_card_type,credit_card_number,credit_card_cvv,credit_card_expiry,state,password)  VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
